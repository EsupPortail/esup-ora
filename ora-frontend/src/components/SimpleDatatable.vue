<template>
  <v-data-table :items="items" :headers="headers" :loading="loading" item-value="id" hover>
    <template v-slot:top>
      <v-toolbar>
        <v-toolbar-title>
          <v-btn color="success" variant="elevated" @click="isAdd = true"> Nouveau </v-btn>
          <v-btn
    ...
    <template v-slot:item="{ item }">
      <tr v-if="item.id !== itemToEdit.id">
        <template v-for="field in headers" :key="field.key">
      ...
      <tr v-else>
        ...
        <td>
          <v-btn color="success" variant="text" icon="mdi-check-circle" @click="updateItem"></v-btn>
          <v-btn color="red" variant="text" icon="mdi-close" @click="itemToEdit = {}"></v-btn>
        </td>
      </tr>
    </template>
    ...
    <template v-if="isAdd" v-slot:body.prepend>
      <tr>
        <td v-for="field in headers" :key="field.key">
          <v-btn v-if="field.key === 'actions'" @click="createItem" color="success">

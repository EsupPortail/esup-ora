...
CREATE TABLE "RoleToUser" (
    ...
    CONSTRAINT "RoleToUser_pkey" PRIMARY KEY ("idUserKeycloak","roleId")
);
...
-- AddForeignKey
ALTER TABLE "Categorie" ADD CONSTRAINT "Categorie_namespaceId_fkey" FOREIGN KEY ("namespaceId") REFERENCES "Namespace"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

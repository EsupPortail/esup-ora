...
// export async function middlewareGuardian(req : Request, res : Response, next : NextFunction) {
//     let currentToken = undefined;
//     let middlewareIsOk = false;

//     console.error('MiddlewareGuardian : Request received for URL:', req.url);
//     if( req.body.oratoken === undefined ) {
//         return res.status( 301 ).json({ redirect: true, redirectPath: '/login' } );
//     } else {
...
// // const testAuthentHandler = async ( req : Request, method : string, expectedHeaders , expectedBody ) => {
